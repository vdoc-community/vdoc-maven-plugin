...
public class CreateSetupMojo extends AbstractDeployerVDocMojo {
   ...
   * <b>Warning : </b> if you turn on this option it's highly recommended to used <a
   * href="https://cwiki.apache.org/confluence/display/MAVEN/Parallel+builds+in+Maven+3" >Parallel
   * builds</a>.<br>
   * Else the module with this option set to true should be the last to be build (to avoid thread
   * locking).
   */
  @Parameter(defaultValue = "false")
  ...
  public void execute() throws MojoExecutionException, MojoFailureException {
    ...
    this.zipEntryFilters.add(
        new VersionPropertyFilter(StringUtils.substringBeforeLast(this.project.getVersion(), "."),
            "UTF-8"));
